...
\begin{figure}[htbp]
    \includegraphics[width=2.8in]{img/SunsPath2.png}
    \centering
    \captionsetup{justification=centering}
...
\begin{figure}[htbp]
	\includegraphics[width=75mm]{img/ComparisonTrackingVsNoTracking.png}
	\centering
	\captionsetup{justification=centering}
...
\begin{figure}[!t]
    \includegraphics[width=70mm]{img/Application_Setup.png}
    \centering
    \captionsetup{justification=centering}
...
\begin{figure}[!t]
    ...
    \includegraphics[width=80mm]{img/Application_Flow_Graph.jpg}\centering
    \captionsetup{justification=centering}

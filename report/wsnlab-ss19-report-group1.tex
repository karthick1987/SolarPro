...
\subsubsection{Panel Motes}
    The panel Motes runs a subset of the base station code and is more simplified. They only react to unicast and broadcast messages and they resond based on the packet type.

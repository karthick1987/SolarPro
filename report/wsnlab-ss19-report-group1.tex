...
For our application of using a Wireless sensor network for solar tracking, we are using 3 different kinds of sensors, 7 motes to control 7 panels, 

\subsection{Sensors}
Described below are the different types of sensors used in our application along and their uses:

\begin{itemize}
    \item Servo Motor - HS-422\cite{servoMotor}\newline
        The servos will be used to change the angle of solar panels.

...
\begin{itemize}
    \item Servo Motor x 7 (1 per mote). The servos will be used to change the angle of solar panels.
    \item Light Sensor x 7(1 per mote). The light sensors are used in this proof of concept to simulate the power output of the solar panel.
\end{itemize}
